...
def on_message_check(client, userdata, msgJson):
    if (current_sec_time() - systemWatchTimer) > 57600:  # 16hr
        sendCheckReportToHomeLogic(True, ACTION_RESTART, "Timeout systemWatchTimer, 16hr no activity in commandThread loop")
    else:
